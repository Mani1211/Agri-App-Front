...
const routes: Routes = [
  ...
  { path: "login", component: LoginComponent },
  {
    ...
    children: [
      ...
      {
        path: "editbalerrentincome/:id",
        component: BalerRentIncomeEditComponent,
      },
      {
        path: "editbalersellincome/:id",
        component: BalerSellIncomeEditComponent,
      },
...
@NgModule({
  ...
  imports: [
    ...
    AngularFireModule.initializeApp({
      apiKey: "AIzaSyAguUhwPbuucm2AdlInoQ-035Gj4eThOl4",
      authDomain: "touron-ec495.firebaseapp.com",
      databaseURL: "https://touron-ec495.firebaseio.com",
      projectId: "touron-ec495",
      storageBucket: "touron-ec495.appspot.com",
      messagingSenderId: "409064027402",
      appId: "1:409064027402:web:b862147f28ec746176f6f3",
      measurementId: "G-GPR1Q58LZ8",
    }),
    CommonModule,
    AppRoutingModule,
