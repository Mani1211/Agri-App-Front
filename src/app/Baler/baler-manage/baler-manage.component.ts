...
export class BalerManageComponent implements OnInit {
 ...
 @ViewChild(MatPaginator) paginator3:MatPaginator
  ...
  constructor(private snackbar:MatSnackBar,private router:Router,private balerRent:BalerService,private balerSell:BalersellService) { }

  displayedColumns1: string[] = ['date','customerName','customerPlace','billNumber','numberOfBales','rentOfBales','totalAmount','advance','balance','amountGiven','actions'];

  displayedColumns2: string[] = ['date','buyerName','buyerCellNumber','vehicleNumber','numberOfBales','costPerBales','totalAmount','advance','balance','amountGiven','actions'];

  displayedColumns3: string[] = ['date','driverName','managerName','driverSalary','managerSalary','workerSalary','petrol','diesel','service','spare','juteCost','hayCost','foodCost','totalAmount','actions'];
