...
export class BalerRentIncomeEditComponent implements OnInit {
 ...
 income;
  ...
  updateIncome(date,customerName,customerPlace,billNumber,numberOfBales,rentOfBales,totalAmount,advance,balance,amountGiven){
    this.baler.updateIncome(this.id,date,customerName,customerPlace,billNumber,numberOfBales,rentOfBales,totalAmount,advance,balance,amountGiven).subscribe(res=>{
