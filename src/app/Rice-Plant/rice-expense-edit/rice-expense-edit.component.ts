...
createForm(){
  ...
  updateRiceExpense(driverName,managerName,driverSalary,managerSalary,
    date,petrol,diesel,service,spare,foodCost,totalAmount){
      console.log(driverName,managerName,driverSalary,managerSalary,
        date,petrol,diesel,service,spare,foodCost,totalAmount)
      this.details.updateRiceExpense(this.id,driverName,managerName,driverSalary,managerSalary,
